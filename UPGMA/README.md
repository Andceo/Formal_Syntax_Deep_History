...
7. **Hamming**: In this folder, the analysis is reproduced using a Hamming distance instead (cf. Supplementary Material).

8. **Fig3.pdf**: Figure 3 from the paper (UPGMA tree).
